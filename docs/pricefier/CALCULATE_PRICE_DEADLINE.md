...
Documentação dos Correios: `CalcPrecoPrazo`

Calcula o custo (frete) e o prazo de de entrega de uma encomenda entre dois CEPs considerando o serviço utilizado, seriviços adicionais
...
...
Correios::Pricefier.calculate_price_deadline({
